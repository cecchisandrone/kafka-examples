...
public class OrderCreated extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = 4326053211277634306L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser()
            .parse("{\"type\":\"record\",\"name\":\"OrderCreated\",\"namespace\":\"com.voxloud.kafka.event\",\"fields\":[{\"name\":\"order_id\"," +
                    "\"type\":\"string\",\"doc\":\"Id of the order filed\"},{\"name\":\"customer_id\",\"type\":\"string\",\"doc\":\"Id of the " +
                    "customer\"},{\"name\":\"items\",\"type\":\"int\",\"doc\":\"Total number of items in the order\"},{\"name\":\"price\"," +
                    "\"type\":\"float\",\"doc\":\"Total price of the order\"}]}");
    ...
    @Deprecated
    public java.lang.CharSequence order_id;
    /** Id of the customer */
    @Deprecated
     ...
     */
    public OrderCreated(java.lang.CharSequence order_id, java.lang.CharSequence customer_id, java.lang.Integer items, java.lang.Float price) {
     ...
     */
    public static com.voxloud.kafka.event.OrderCreated.Builder newBuilder() {
        return new com.voxloud.kafka.event.OrderCreated.Builder();
    }
     ...
     * @return A new OrderCreated RecordBuilder
     */
    public static com.voxloud.kafka.event.OrderCreated.Builder newBuilder(com.voxloud.kafka.event.OrderCreated.Builder other) {
        return new com.voxloud.kafka.event.OrderCreated.Builder(other);
    }
     ...
     * @return A new OrderCreated RecordBuilder
     */
    public static com.voxloud.kafka.event.OrderCreated.Builder newBuilder(com.voxloud.kafka.event.OrderCreated other) {
        return new com.voxloud.kafka.event.OrderCreated.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCreated>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.voxloud.kafka.event.OrderCreated.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.voxloud.kafka.event.OrderCreated other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.order_id)) {
                this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder setOrderId(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder clearOrderId() {
            order_id = null;
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder setCustomerId(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder clearCustomerId() {
            customer_id = null;
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder setItems(int value) {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder clearItems() {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder setPrice(float value) {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCreated.Builder clearPrice() {
