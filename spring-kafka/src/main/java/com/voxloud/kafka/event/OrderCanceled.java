...
public class OrderCanceled extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -7036955926128861796L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser()
            .parse("{\"type\":\"record\",\"name\":\"OrderCanceled\",\"namespace\":\"com.voxloud.kafka.event\",\"fields\":[{\"name\":\"order_id\"," +
                    "\"type\":\"string\",\"doc\":\"Id of the order filed\"},{\"name\":\"timestamp\",\"type\":\"long\",\"doc\":\"Date of the " +
                    "cancellation\",\"logicalType\":\"date\"}]}");
     ...
     */
    public OrderCanceled(java.lang.CharSequence order_id, java.lang.Long timestamp) {
     ...
     */
    public static com.voxloud.kafka.event.OrderCanceled.Builder newBuilder() {
        return new com.voxloud.kafka.event.OrderCanceled.Builder();
    }
     ...
     * @return A new OrderCanceled RecordBuilder
     */
    public static com.voxloud.kafka.event.OrderCanceled.Builder newBuilder(com.voxloud.kafka.event.OrderCanceled.Builder other) {
        return new com.voxloud.kafka.event.OrderCanceled.Builder(other);
    }
     ...
     * @return A new OrderCanceled RecordBuilder
     */
    public static com.voxloud.kafka.event.OrderCanceled.Builder newBuilder(com.voxloud.kafka.event.OrderCanceled other) {
        return new com.voxloud.kafka.event.OrderCanceled.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderCanceled>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(com.voxloud.kafka.event.OrderCanceled.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(com.voxloud.kafka.event.OrderCanceled other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.order_id)) {
                this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCanceled.Builder setOrderId(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCanceled.Builder clearOrderId() {
            order_id = null;
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCanceled.Builder setTimestamp(long value) {
         ...
         * @return This builder.
         */
        public com.voxloud.kafka.event.OrderCanceled.Builder clearTimestamp() {
