 ...
 */
package com.voxloud.kafka.user;
...
public class UserValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser()
            .parse("{\"type\":\"record\",\"name\":\"UserValue\",\"namespace\":\"com.example.user\",\"fields\":[{\"name\":\"name\"," +
                    "\"type\":\"string\",\"doc\":\"User name\"},{\"name\":\"surname\",\"type\":\"string\",\"doc\":\"User surname\"}," +
                    "{\"name\":\"age\",\"type\":\"int\",\"doc\":\"User age\",\"default\":0},{\"name\":\"email\",\"type\":\"string\",\"doc\":\"User " +
                    "email\",\"default\":\"node@mail.it\"}]}");
    ...
    /** User surname */
    @Deprecated
    public java.lang.CharSequence surname;
    /** User age */
    @Deprecated
    public int age;
    /** User email */
     ...
     */
    public static UserValue.Builder newBuilder() {
        return new UserValue.Builder();
    }
     ...
     * @return A new UserValue RecordBuilder
     */
    public static UserValue.Builder newBuilder(UserValue.Builder other) {
        return new UserValue.Builder(other);
    }
     ...
     * @return A new UserValue RecordBuilder
     */
    public static UserValue.Builder newBuilder(UserValue other) {
        return new UserValue.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserValue>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(UserValue.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(UserValue other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.name)) {
                this.name = data().deepCopy(fields()[0].schema(), other.name);
                fieldSetFlags()[0] = true;
         ...
         * @return This builder.
         */
        public UserValue.Builder setName(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public UserValue.Builder clearName() {
            name = null;
         ...
         * @return This builder.
         */
        public UserValue.Builder setSurname(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public UserValue.Builder clearSurname() {
            surname = null;
         ...
         * @return This builder.
         */
        public UserValue.Builder setAge(int value) {
         ...
         * @return This builder.
         */
        public UserValue.Builder clearAge() {
         ...
         * @return This builder.
         */
        public UserValue.Builder setEmail(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public UserValue.Builder clearEmail() {
            email = null;
